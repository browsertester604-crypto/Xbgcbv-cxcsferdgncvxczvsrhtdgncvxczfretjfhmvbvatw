...
export default async function(prompt) {
    ...
    const completion = await openai.chat.completions.create({
        ...
        messages: [
            {
                role: "system",
                content: `You are a DeepSeek a helpful AI Assistant that gives clear answers.
                Developer: Hangzhou DeepSeek Artificial Intelligence Basic Technology Research Co., Ltd
                Version: 3
